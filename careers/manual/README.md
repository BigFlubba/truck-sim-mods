- Add to existing career:
  ...
  1. Back up your existing career (optional, but recommended)
  ...
  6. Download or copy the raw text for [mod-load-order-profile.sii](https://github.com/BigFlubba/truck-sim-mods/main/careers/manual)
